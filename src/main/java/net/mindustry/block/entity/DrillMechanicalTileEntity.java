package net.mindustry.block.entity;
...
import net.mindustry.init.MindustryModBlockEntities;
...
public class DrillMechanicalTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(1, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public DrillMechanicalTileEntity(BlockPos pos, BlockState state) {
		super(MindustryModBlockEntities.DRILL_MECHANICAL.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<DrillMechanicalTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<DrillMechanicalTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("drill_mechanical");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new DrillContainerCacheMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}

	@Override
	public Component getDisplayName() {
		return Component.literal("Drill Mechanical");
	}
